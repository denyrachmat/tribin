...
Route::group(['prefix' => 'master', 'middleware' => 'api'], function () {
    Route::get('gencode/{id}/{value?}/{cg?}', [gencodeController::class, 'getGencode']);
...
Route::post('/setting/tree/roles', [AccessRulesController::class, 'setAccess'])
    ->middleware([\App\Http\Middleware\EncryptCookies::class, \Illuminate\Session\Middleware\StartSession::class, 'auth']);
