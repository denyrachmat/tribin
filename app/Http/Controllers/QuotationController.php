...
class QuotationController extends Controller
{
    ...
    function loadByIdOld(Request $request)
    {
        ...
        $RS = T_QUODETA::on($this->dedicatedConnection)
            ->select(["T_QUODETA.id", "TQUODETA_ITMCD", "MITM_ITMNM", DB::raw("CONCAT(MUSAGE_ALIAS, ' ', MUSAGE_DESCRIPTION) AS TQUODETA_USAGE_DESCRIPTION"), "TQUODETA_PRC", "TQUODETA_OPRPRC", "TQUODETA_MOBDEMOB", 'TQUODETA_ITMQT', 'TQUODETA_ELECTRICITY'])
