    ...
    <nav id="main-menu-navigation" class="navigation-main">
        ...
        <div class="nav-item has-sub {{ request()->routeIs('admin.employee.*') ? 'active open' : '' }} {{ request()->routeIs('admin.overtime.*') ? 'active open' : '' }} {{ request()->routeIs('admin.cashadvance.*') ? 'active open' : '' }}">
            ...
            <div class="submenu-content">
                <a href="{{ route('employee.create') }}" class="menu-item {{ request()->routeIs('admin.employee.create') ? 'active' : '' }}"><i class="ik ik-user-plus"></i>Add New Employee</a>
                <a href="{{ route('employee.index') }}" class="menu-item {{ request()->routeIs('admin.employee.index') ? 'active' : '' }}"><i class="ik file-text ik-file-text"></i>List Of Employees</a>
                <a href="{{ route('overtime.index') }}" class="menu-item {{ request()->routeIs('admin.overtime.*') ? 'active' : '' }}"><i class="ik watch ik-watch"></i>Overtime</a>
                <a href="{{ route('cashadvance.index') }}" class="menu-item {{ request()->routeIs('admin.cashadvance.index') ? 'active' : '' }}"><i class="ik at-sign ik-at-sign"></i>Cash Advance</a>
            </div>
        </div>
        ...
        <div class="nav-item has-sub {{ request()->routeIs('attendance.*') ? 'active open' : '' }}">
            ...
            <div class="submenu-content">
                <a href="{{ route('attendance.create') }}" class="menu-item {{ request()->routeIs('admin.attendance.create') ? 'active' : '' }}"><i class="ik ik-plus-circle"></i>Add New Attendance</a>
                <a href="{{ route('attendance.index') }}" class="menu-item {{ request()->routeIs('admin.attendance.index') ? 'active' : '' }}"><i class="ik file-text ik-file-text"></i>List Of Attendance</a>
            </div>
        </div>
